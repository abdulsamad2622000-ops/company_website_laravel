...
return ['ai-machine-learning' => [
    ...
    'custom-software-development' => [
        ...
        'whyUs' => [
            'Battle-tested development process with Proven development process refined across 70+ delivered projects',
    ...
    'erp-development' => [
        ...
        'whyUs' => [
            'ERP specialists with deep, hands-on domain experience',
    ...
    'crm-development' => [
        ...
        'whyUs' => [
            'Fully custom — not a reskinned off-the-shelf CRM template',
    ...
    'Architected for high availability with load balancing',
    'Security-first approach with GDPR-conscious data handling',
    ...
    'mvp-development' => [
        ...
        'whyUs' => [
            ...
            'Trusted by founders to turn ideas into fundable products',
        ],
    ],
    'enterprise-software' => [
    ...
    'Compliance-conscious design (GDPR & industry best practices)',
    ...
    '24/7 monitoring & rapid incident response',
        ...
        'whyUs' => [
    'Enterprise-grade engineering practices and standards',
    'Experienced DevOps and security-focused engineers',
    ...
    'Fast ROI — automations designed to pay for themselves quickly',
    ...
    'Accessibility-first design approach (WCAG-aligned best practices)',
    'Generous revision rounds until you\'re happy with the result',
],
    ],
    'mobile-app-ui-ux' => [
    ...
    [
        'icon' => 'bi bi-android2',
        'title' => 'Android Teams',
        'desc' => 'Material Design 3-aligned UI with platform best practices',
    ],
    [
        'icon' => 'bi bi-apple',
        'title' => 'iOS Teams',
        'desc' => 'Human Interface Guidelines-aligned design for a native iOS feel',
    ],
    [
        'icon' => 'bi bi-people',
        'title' => 'Product Teams',
    ...
    'accessibility-services' => [
        ...
        'features' => [
    'WCAG 2.1 (A, AA, AAA) conformance audit',
    ...
    [
        'icon' => 'bi bi-buildings',
        'title' => 'Enterprises',
        'desc' => 'Work toward ADA, EN 301 549, and WCAG conformance',
    ],
    [
        'icon' => 'bi bi-mortarboard',
        'title' => 'EdTech & Gov',
        'desc' => 'Built for platforms with strict accessibility requirements',
    ],
    [
        'icon' => 'bi bi-heart',
        'title' => 'Inclusive Brands',
        'desc' => 'Reach more users, including people with disabilities',
    ],
],
       'whyUs' => [
    'Experienced in accessibility auditing and remediation',
    'Remediation + testing — not just a report',
    'Screen reader tested on NVDA, JAWS, and VoiceOver',
    'Detailed documentation of fixes and conformance status',
    ...
    'SEO-friendly, server-side rendering with Next.js',
    'OWASP top 10 security standards enforced',
    'Strong automated test coverage across the codebase',
    'Optimised for high Lighthouse performance scores',
],
    ],
    'backend-development' => [
    ...
    'Automated testing with strong unit and integration coverage',
    'Rate limiting, input validation, and security baked in',
    'Database indexing and query performance tuning',
    'Built for high availability with proactive monitoring',
],
    ],
    'e-commerce-solutions' => [
        ...
        'whyUs' => [
    'Custom-built — no recurring platform fees or template limitations',
    ...
    'Secure payment handling via trusted, industry-standard gateways',
],
    ],
    ...
    'Built and load-tested for high-traffic reliability',
    'Monitoring and alerting included for peace of mind',
    'Secure by design — follows OWASP API security best practices',
],
    ],
    'cloud-solutions' => [
        ...
        'whyUs' => [
    'Experienced engineers across AWS, GCP, and Azure',
    'Proven track record of reducing cloud costs for migration clients',
    ...
    'devops-services' => [
        ...
        'whyUs' => [
    'Experienced engineers with production Kubernetes expertise',
    'Significant reduction in deployment time and effort',
    ...
    'Security assessment aligned with ISO 27001 & GDPR principles',
],
        'benefits' => [
    [
        'icon' => 'bi bi-building',
    ...
    [
        'icon' => 'bi bi-cart',
        'title' => 'E-Commerce',
        'desc' => 'Payment security hardening for online stores',
    ],
    [
        'icon' => 'bi bi-heart',
        'title' => 'Healthcare',
        'desc' => 'Security controls built for sensitive patient data',
    ],
],
       'whyUs' => [
    'Experienced ethical hackers and security engineers',
    ...
    'infrastructure-design' => [
       ...
       'whyUs' => [
    'Experience designing infrastructure for high-scale systems',
    ...
    'Experience across a wide range of industries and business models',
    ...
    'Tested across a range of physical Android devices',
    'Play Store listing optimisation (ASO) included',
    'UX designed for strong user engagement and retention',
    ...
    'ios-app-development' => [
        ...
        'category' => 'Mobile Apps',
        'icon' => 'bi bi-apple',
       'tagline' => 'Polished iOS apps. Built to Apple\'s standards. Users love them.',
    ...
    'iOS Human Interface Guidelines-aligned design',
    ...
    'Strong track record of smooth App Store submissions',
    ...
    [
        'icon' => 'bi bi-coin',
        'title' => 'Cost-Conscious Teams',
        'desc' => 'Significant savings vs. building separate native apps',
    ],
    [
        'icon' => 'bi bi-rocket',
        'title' => 'Startups',
    ...
    [
        'icon' => 'bi bi-shield',
        'title' => 'Regulated Industries',
        'desc' => 'Built with security and compliance needs in mind for banking, health, and legal',
    ],
],
       'whyUs' => [
    ...
    'Architected to scale with your organisation\'s growth',
    'Dedicated enterprise support team available',
],
    ],
    'on-demand-service-apps' => [
        ...
        'category' => 'Mobile Apps',
        'icon' => 'bi bi-truck-front',
'tagline' => 'On-demand marketplace apps. Built for your business.',
'description' => 'We build complete on-demand service platforms for any service vertical — from ride-hailing and delivery to home services. Our solutions include separate apps for customers, service providers, and drivers, plus a powerful admin dashboard to manage everything in real time.',        'features' => [
    ...
    'Real-time location tracking with fast, reliable updates',
    'Surge pricing and availability logic built in',
    'Architected to scale as your bookings grow',
    ...
    'fintech-banking-apps' => [
        ...
        'category' => 'Mobile Apps',
        'icon' => 'bi bi-coin',
'tagline' => 'Secure financial apps. Built with compliance in mind.',
'description' => 'We develop highly secure mobile applications for banks, fintech startups, payment companies, and investment platforms, built with financial industry security and compliance standards in mind. From digital wallets and money transfer apps to trading platforms and micro-lending solutions, we build financial apps that users trust.',
       'features' => [
    'Secure payment handling following industry standards',
    ...
    [
        ...
        'desc' => 'Wallet, lending, or payments apps built with compliance in mind',
    ],
    [
        'icon' => 'bi bi-graph-up',
        ...
        'whyUs' => [
    'Experienced in building secure financial applications',
    'Development practices aligned with PCI-DSS standards',
    'End-to-end encryption for all financial data',
    'Experience integrating with banking and payment APIs',
    'Security-first approach for regulated financial products',
],
    ],
...
'description' => 'We build mobile applications designed with healthcare data privacy standards in mind, for hospitals, clinics, telehealth providers, and healthtech startups. From patient portals and telemedicine apps to EHR integrations and remote monitoring solutions, we deliver healthcare technology that improves patient outcomes and clinical efficiency.',
       'features' => [
    'Data handling & encryption aligned with HIPAA principles',
    ...
    [
        ...
        'desc' => 'Telehealth and wellness platforms built with privacy in mind',
    ],
    [
        'icon' => 'bi bi-heart',
        'title' => 'Patients',
       ...
       'whyUs' => [
    'Experienced in building healthcare data privacy-conscious apps',
    ...
    'Strong data security and audit logging practices',
],
    ],
    'maintenance-support' => [
    ...
    'Clear support agreements with defined response times',
...
'description' => 'We provide comprehensive quality assurance and testing services to ensure your software is reliable, performant, and ready for real users. Our QA engineers combine manual testing with automated test suites to catch issues before they reach production — protecting your reputation and user experience.',
        'features' => [
        ...
        'whyUs' => [
    'Experienced QA engineers with a rigorous testing process',
    'Test automation that runs on every code commit (CI/CD)',
    'Load testing built to your expected traffic and scale',
...
'description' => 'We handle the complete process of submitting, optimising, and managing your app on the Apple App Store and Google Play Store. From preparing store assets and metadata to navigating review guidelines and optimising for discoverability (ASO), we guide your app through a smooth launch process.',
        'features' => [
       ...
       'whyUs' => [
    'Strong track record of smooth App Store and Play Store submissions',
